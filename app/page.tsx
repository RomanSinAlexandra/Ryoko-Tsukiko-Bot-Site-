...
export default function Home() {
  ...
  useEffect(() => {
    // Запускаем звук при загрузке
    playSound('/Sound/start.wav');

    // Убираем оверлей вспышки через 1 секунду
  ...
  return (
    <>
      {/* Белая вспышка при входе */}
      {isFlashing && <div className={styles.flashOverlay}></div>}
        ...
        <div className={styles.sectionsContainer}>
          ...
          <div className={styles.section}>
            <div className={styles.contentWrapper}>
              <TextCard
                title="News!"
                text="News from around the world about anime, games, and more is available on your Discord server! With support for three languages ​​and various sources, just specify the time and channel."
                fontHSize="clamp(32px, 5vw, 64px)"
                fontSize="clamp(16px, 2vw, 48px)"
              />
            </div>
